...
class StoreReviewsTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        \DB::table('store_reviews')->delete();

        factory(\App\Models\StoreReview::class,20)->create();
        
//        \DB::table('store_reviews')->insert(array (
//            0 =>
//            array (
//                'id' => 1,
