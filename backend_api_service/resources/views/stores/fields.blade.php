...
<div style="flex: 50%;max-width: 50%;padding: 0 4px;" class="column">
    ...
    <!-- franchises Field -->
    <div class="form-group row ">
        {!! Form::label('franchises[]', trans("lang.store_franchises"),['class' => 'col-3 control-label text-right']) !!}
        <div class="col-9">
            {!! Form::select('franchises[]', $franchise, $franchisesSelected, ['class' => 'select2 form-control' , 'multiple'=>'multiple']) !!}
            <div class="form-text text-muted">{{ trans("lang.store_franchises_help") }}</div>
        </div>
    </div>
    ...
    <!-- Address Field -->
    <div class="form-group row ">
        {!! Form::label('address', trans("lang.store_address"), ['class' => 'col-3 control-label text-right']) !!}
        <div class="col-9">
            {!! Form::text('address', null,  ['class' => 'form-control','placeholder'=>  trans("lang.store_address_placeholder")]) !!}
            <div class="form-text text-muted">
    ...
    <!-- Latitude Field -->
    <div class="form-group row ">
        {!! Form::label('latitude', trans("lang.store_latitude"), ['class' => 'col-3 control-label text-right']) !!}
        <div class="col-9">
            {!! Form::text('latitude', null,  ['class' => 'form-control','placeholder'=>  trans("lang.store_latitude_placeholder")]) !!}
            <div class="form-text text-muted">
    ...
    <!-- Longitude Field -->
    <div class="form-group row ">
        {!! Form::label('longitude', trans("lang.store_longitude"), ['class' => 'col-3 control-label text-right']) !!}
        <div class="col-9">
            {!! Form::text('longitude', null,  ['class' => 'form-control','placeholder'=>  trans("lang.store_longitude_placeholder")]) !!}
            <div class="form-text text-muted">
