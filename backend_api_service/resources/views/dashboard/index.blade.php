        ...
        <div class="row">
            ...
            <div class="col-lg-3 col-6">
                ...
                <div class="small-box bg-success">
                    <div class="inner">
                        <h3>{{$storesCount}}</h3>
                        <p>{{trans('lang.store_plural')}}</p>
                    </div>
                    <div class="icon">
                        <i class="fa fa-building"></i>
                    </div>
                    <a href="{!! route('stores.index') !!}" class="small-box-footer">{{trans('lang.dashboard_more_info')}} <i class="fa fa-arrow-circle-right"></i></a>
                </div>
            </div>
            <!-- ./col -->
            <div class="col-lg-3 col-6">
                ...
                <div class="card">
                    <div class="card-header no-border">
                        ...
                        <div class="card-tools">
                            <a href="{{route('stores.index')}}" class="btn btn-tool btn-sm"><i class="fa fa-bars"></i> </a>
                        </div>
                    </div>
                    <div class="card-body p-0">
                        <table class="table table-striped table-valign-middle">
                            ...
                            <tr>
                                ...
                                <th>{{trans('lang.store_address')}}</th>
                            ...
                            @foreach($stores as $store)
                                ...
                                <tr>
                                    <td>
                                        {!! getMediaColumn($store, 'image','img-circle img-size-32 mr-2') !!}
                                    </td>
                                    <td>{!! $store->name !!}</td>
                                    <td>
                                        {!! $store->address !!}
                                    ...
                                    <td class="text-center">
                                        <a href="{!! route('stores.edit',$store->id) !!}" class="text-muted"> <i class="fa fa-edit"></i> </a>
                                    </td>
                                </tr>
                            @endforeach
                            </tbody>
