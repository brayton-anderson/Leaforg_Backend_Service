...
@can('franchises.index')
    <li class="nav-item">
        <a class="nav-link {{ Request::is('franchises*') ? 'active' : '' }}" href="{!! route('franchises.index') !!}">@if($icons)
                <i class="nav-icon fa fa-globe"></i>@endif<p>{{trans('lang.franchise_plural')}}</p></a>
    </li>
@endcan

@can('stores.index')
    <li class="nav-item has-treeview {{ (Request::is('stores*') || Request::is('requestedStores*') || Request::is('galleries*') || Request::is('storeReviews*')) && !Request::is('storesPayouts*') ? 'menu-open' : '' }}">
        <a href="#" class="nav-link {{ (Request::is('stores*') || Request::is('requestedStores*') || Request::is('galleries*') || Request::is('storeReviews*')) && !Request::is('storesPayouts*')? 'active' : '' }}"> @if($icons)
                <i class="nav-icon fa fa-building"></i>@endif
            <p>{{trans('lang.store_plural')}} <i class="right fa fa-angle-left"></i>
            </p>
        </a>
        <ul class="nav nav-treeview">
            @can('stores.index')
                <li class="nav-item">
                    <a class="nav-link {{ Request::is('requestedStores*') ? 'active' : '' }}" href="{!! route('requestedStores.index') !!}">@if($icons)
                            <i class="nav-icon fa fa-reorder"></i>@endif<p>{{trans('lang.requested_stores_plural')}}</p></a>
                </li>
                <li class="nav-item">
                    <a class="nav-link {{ Request::is('stores*') ? 'active' : '' }}" href="{!! route('stores.index') !!}">@if($icons)
                            <i class="nav-icon fa fa-building"></i>@endif<p>{{trans('lang.store_plural')}}</p></a>
                </li>
            @endcan
            @can('galleries.index')
                <li class="nav-item">
            ...
            @endcan
            @can('storeReviews.index')
                <li class="nav-item">
                    <a class="nav-link {{ Request::is('storeReviews*') ? 'active' : '' }}" href="{!! route('storeReviews.index') !!}">@if($icons)
                            <i class="nav-icon fa fa-comments"></i>@endif<p>{{trans('lang.store_review_plural')}}</p></a>
                </li>
            @endcan
        </ul>
    </li>
...
@can('products.index')
    <li class="nav-item has-treeview {{ Request::is('products*') || Request::is('extra*') || Request::is('productReviews*') || Request::is('nutrition*') ? 'menu-open' : '' }}">
        <a href="#" class="nav-link {{ Request::is('products*') || Request::is('extra*') || Request::is('productReviews*') || Request::is('nutrition*') ? 'active' : '' }}"> @if($icons)
...
@can('payments.index')
    <li class="nav-item has-treeview {{ Request::is('earnings*') || Request::is('driversPayouts*') || Request::is('storesPayouts*') || Request::is('payments*') ? 'menu-open' : '' }}">
        <a href="#" class="nav-link {{ Request::is('earnings*') || Request::is('driversPayouts*') || Request::is('storesPayouts*') || Request::is('payments*') ? 'active' : '' }}"> @if($icons)
        ...
        <ul class="nav nav-treeview">
            ...
            @can('storesPayouts.index')
                <li class="nav-item">
                    <a class="nav-link {{ Request::is('storesPayouts*') ? 'active' : '' }}" href="{!! route('storesPayouts.index') !!}">@if($icons)
                            <i class="nav-icon fa fa-dollar"></i>@endif<p>{{trans('lang.stores_payout_plural')}}</p></a>
                </li>
            @endcan
