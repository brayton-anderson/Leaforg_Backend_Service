...
<div style="flex: 50%;max-width: 50%;padding: 0 4px;" class="column">
    ...
    <!-- Ingredients Field -->
    <div class="form-group row ">
        {!! Form::label('ingredients', trans("lang.product_ingredients"), ['class' => 'col-3 control-label text-right']) !!}
        <div class="col-9">
            {!! Form::textarea('ingredients', null, ['class' => 'form-control','placeholder'=>
             trans("lang.product_ingredients_placeholder")  ]) !!}
            <div class="form-text text-muted">{{ trans("lang.product_ingredients_help") }}</div>
        </div>
    </div>
    ...
    <!-- Weight Field -->
    <div class="form-group row ">
        {!! Form::label('weight', trans("lang.product_weight"), ['class' => 'col-3 control-label text-right']) !!}
        <div class="col-9">
            {!! Form::number('weight', null,  ['class' => 'form-control','placeholder'=>  trans("lang.product_weight_placeholder"),'step'=>"0.01", 'min'=>"0"]) !!}
            <div class="form-text text-muted">
                {{ trans("lang.product_weight_help") }}
            </div>
        </div>
    </div>
    ...
    <!-- Store Id Field -->
    <div class="form-group row ">
        {!! Form::label('store_id', trans("lang.product_store_id"),['class' => 'col-3 control-label text-right']) !!}
        <div class="col-9">
            {!! Form::select('store_id', $store, null, ['class' => 'select2 form-control']) !!}
            <div class="form-text text-muted">{{ trans("lang.product_store_id_help") }}</div>
        </div>
    </div>
