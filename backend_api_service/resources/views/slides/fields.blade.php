...
<!-- Image Fit Field -->
    ...
    <!-- Store Id Field -->
    <div class="form-group row ">
        {!! Form::label('store_id', trans("lang.slide_store_id"),['data-empty'=>trans("lang.slide_store_id_placeholder"),'class' => 'col-3 control-label text-right']) !!}
        <div class="col-9">
            {!! Form::select('store_id', $store, null, ['class' => 'select2 not-required form-control']) !!}
            <div class="form-text text-muted">{{ trans("lang.slide_store_id_help") }}</div>
        </div>
    </div>
