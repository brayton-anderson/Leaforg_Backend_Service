...
Route::middleware('auth')->group(function () {
    ...
    Route::post('franchises/remove-media', 'FranchiseController@removeMedia');
    Route::resource('franchises', 'FranchiseController')->except([
        'show'
    ]);

    Route::post('stores/remove-media', 'StoreController@removeMedia');
    Route::get('requestedStores', 'StoreController@requestedStores')->name('requestedStores.index'); //adeed
    ...
    Route::resource('storeReviews', 'StoreReviewController')->except([
        'show'
    ]);
    ...
    Route::resource('storesPayouts', 'StoresPayoutController')->except([
        'show', 'edit', 'update'
    ]);
