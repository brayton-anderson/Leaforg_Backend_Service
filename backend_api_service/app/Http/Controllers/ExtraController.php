...
class ExtraController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('extras.create')->with("customFields", isset($html) ? $html : false)->with("product", $product)->with("extraGroup", $extraGroup);
    }
    ...
    public function edit($id)
    {
        ...
        return view('extras.edit')->with('extra', $extra)->with("customFields", isset($html) ? $html : false)->with("product", $product)->with("extraGroup", $extraGroup);
    }
