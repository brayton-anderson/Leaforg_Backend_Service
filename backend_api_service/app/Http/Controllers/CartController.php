...
class CartController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('carts.create')->with("customFields", isset($html) ? $html : false)->with("product", $product)->with("user", $user)->with("extra", $extra)->with("extrasSelected", $extrasSelected);
    }
    ...
    public function edit($id)
    {
        ...
        return view('carts.edit')->with('cart', $cart)->with("customFields", isset($html) ? $html : false)->with("product", $product)->with("user", $user)->with("extra", $extra)->with("extrasSelected", $extrasSelected);
    }
