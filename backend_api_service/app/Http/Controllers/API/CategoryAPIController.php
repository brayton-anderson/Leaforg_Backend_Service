...
use App\Criteria\Categories\CategoriesOfFranchisesCriteria;
use App\Criteria\Categories\CategoriesOfStoreCriteria;
...
class CategoryAPIController extends Controller
{
    ...
    public function index(Request $request)
    {
        try {
            ...
            $this->categoryRepository->pushCriteria(new CategoriesOfFranchisesCriteria($request));
            $this->categoryRepository->pushCriteria(new CategoriesOfStoreCriteria($request));
