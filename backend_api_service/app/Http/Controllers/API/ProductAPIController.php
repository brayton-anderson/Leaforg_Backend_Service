...
use App\Criteria\Products\ProductsOfFranchisesCriteria;
use App\Criteria\Products\ProductsOfDegradablesCriteria;
...
class ProductAPIController extends Controller
{
    ...
    public function index(Request $request)
    {
        try{
            ...
            $this->productRepository->pushCriteria(new ProductsOfFranchisesCriteria($request));
            $this->productRepository->pushCriteria(new ProductsOfDegradablesCriteria($request));
