...
private $orderRepository;
    ...
    public function create()
    {
        ...
        return view('product_orders.create')->with("customFields", isset($html) ? $html : false)->with("product",$product)->with("extra",$extra)->with("extrasSelected",$extrasSelected)->with("order",$order);
    }
    ...
    public function edit($id)
    {
        ...
        $product = $this->productRepository->pluck('name','id');
                $extra = $this->extraRepository->pluck('name','id');
                $order = $this->orderRepository->pluck('id','id');
        $extrasSelected = $productOrder->extras()->pluck('extras.id')->toArray();
        ...
        return view('product_orders.edit')->with('productOrder', $productOrder)->with("customFields", isset($html) ? $html : false)->with("product",$product)->with("extra",$extra)->with("extrasSelected",$extrasSelected)->with("order",$order);
    }
