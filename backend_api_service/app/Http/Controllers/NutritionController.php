...
class NutritionController extends Controller
{
    ...
    public function __construct(NutritionRepository $nutritionRepo, CustomFieldRepository $customFieldRepo, ProductRepository $productRepo)
    {
        parent::__construct();
    ...
    public function create()
    {
        ...
        return view('nutrition.create')->with("customFields", isset($html) ? $html : false)->with("product", $product);
    }
    ...
    public function edit($id)
    {
        ...
        return view('nutrition.edit')->with('nutrition', $nutrition)->with("customFields", isset($html) ? $html : false)->with("product", $product);
    }
