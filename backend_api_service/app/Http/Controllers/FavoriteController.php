...
class FavoriteController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('favorites.create')->with("customFields", isset($html) ? $html : false)->with("product", $product)->with("extra", $extra)->with("extrasSelected", $extrasSelected)->with("user", $user);
    }
    ...
    public function edit($id)
    {
        ...
        return view('favorites.edit')->with('favorite', $favorite)->with("customFields", isset($html) ? $html : false)->with("product", $product)->with("extra", $extra)->with("extrasSelected", $extrasSelected)->with("user", $user);
    }
