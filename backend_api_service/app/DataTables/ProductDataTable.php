...
class ProductDataTable extends DataTable
{
    ...
    public function query(Product $model)
    {
        ...
        if (auth()->user()->hasRole('admin')) {
            return $model->newQuery()->with("store")->with("category")->select('products.*')->orderBy('products.updated_at','desc');
        } else if (auth()->user()->hasRole('manager')) {
            return $model->newQuery()->with("store")->with("category")
    ...
    protected function getColumns()
    {
        $columns = [
            ...
            [
                'data' => 'weight',
                'title' => trans('lang.product_weight'),
            ...
            [
                'data' => 'store.name',
                'title' => trans('lang.product_store_id'),
