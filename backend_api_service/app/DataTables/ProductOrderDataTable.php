<?php
/**
 * File name: ProductOrderDataTable.php
...
class ProductOrderDataTable extends DataTable
{
    ...
    public function dataTable($query)
    {
        ...
        $dataTable = $dataTable
            ...
            ->editColumn('extras', function ($productOrder) {
                return getArrayColumn($productOrder->extras, 'name');
            })
            ->editColumn('price', function ($productOrder) {
                foreach ($productOrder->extras as $extra) {
                    $productOrder['price'] += $extra->price;
                }
    ...
    protected function getColumns()
    {
        $columns = [
            ...
            [
                'data' => 'extras',
                'title' => trans('lang.product_order_extras'),
                'searchable' => false,
                'orderable' => false,
            ],
            [
