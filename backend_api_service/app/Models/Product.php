...
class Product extends Model implements HasMedia
{
    ...
    {
        return $this->hasMany(\App\Models\Extra::class, 'product_id');
    }
    ...
    {
        return $this->hasMany(\App\Models\Nutrition::class, 'product_id');
    }
    ...
    {
        return $this->store()->first(['id', 'name', 'delivery_fee', 'address', 'phone','default_tax','available_for_delivery']);
    }
    ...
    {
        $price = $this->getPrice();
        if(isset($coupon) && count($this->discountables) + count($this->category->discountables) + count($this->store->discountables) > 0){
